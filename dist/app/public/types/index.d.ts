...
export type ExceptionHandler = (err: Error, req: Request) => ExceptionHandlerResult | void;
export type NotFoundHandler = (req: Request) => NotFoundHandlerResult | void;
export type TimerHanlder = (duration: number, timeSpan: TimeSpan[], req: Request, res: Response) => void;
